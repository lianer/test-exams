...
const ExamDescription: React.FC = function () {
  return (
    <div dangerouslySetInnerHTML={{ __html: marked.parse(description) }}></div>
  );
};

const WriteHere: React.FC = function () {
  return <div>Exam1</div>;
};

export { ExamDescription, WriteHere };
